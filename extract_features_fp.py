...
def compute_w_loader(output_path, loader, model, verbose=0):
    ...
    """
    if verbose > 0:
        print(f'processing a total of {len(loader)} batches'.format(
            len(loader)))
...
parser.add_argument('--data_h5_dir', type=str,
                    default='/kaggle/input/panda-patches/PANDA_PATCHES')
parser.add_argument('--data_slide_dir', type=str,
                    default='/kaggle/input/prostate-cancer-grade-assessment/train_images')
parser.add_argument('--slide_ext', type=str, default='.tiff')
parser.add_argument('--csv_path', type=str,
                    default='/kaggle/input/panda-patches/PANDA_PATCHES/process_list_autogen.csv')
...
if __name__ == '__main__':
    ...
    for bag_candidate_idx in tqdm(range(2000, 4000)):
